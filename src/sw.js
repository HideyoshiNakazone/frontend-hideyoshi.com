//Latest CACHE_NAME
var CACHE_NAME = '[v0.0.1] Hideyoshi';
...
var urlsToCache = [
    ...
    '/js/components/loginPopup.component.js',
    '/js/components/result.component.js',
    '/js/components/signupPopup.component.js',
    '/js/configs/appConfig.router.js',
    '/js/controllers/app.controller.js',
    '/js/controllers/home.controller.js',
    '/js/services/clienteAPI.service.js',
    '/js/services/sessionAPI.service.js',
    '/js/value/env.value.js',
    '/js/app.js',
    '/js/index.html',
...
urlsToCache.push(...fontawesome_src);
